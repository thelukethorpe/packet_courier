...
A4\cite{tc_netem_8_man}, whereas the instruction manual for \texttt{ns-3} consists of a 139 pdf\cite{ns_3_man_pdf}.
...
a book of dense technical discourse. This leaves anyone who wants to introduce some notion of packet corruption into
their model stranded to uncover this entrenched information for themselves. These are barriers to entry that
assuredly must be absent in whatever innovation emerges from this thesis.
...
to live in specialist domains whereby teams of engineers can devote the necessary time to examine the tool fully.
Only then could one ever hope to extract all the riches beholden to it.
